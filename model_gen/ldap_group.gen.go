...
func newLdapGroup(db *gorm.DB, opts ...gen.DOOption) ldapGroup {
	...
	_ldapGroup.OrderIndex = field.NewInt32(tableName, "order_index")
	_ldapGroup.HasGroup = field.NewString(tableName, "has_group")
	_ldapGroup.LastSyncTime = field.NewString(tableName, "last_sync_time")
...
type ldapGroup struct {
	...
	HasGroup     field.String
	LastSyncTime field.String
...
func (l *ldapGroup) updateTableName(table string) *ldapGroup {
	...
	l.HasGroup = field.NewString(table, "has_group")
	l.LastSyncTime = field.NewString(table, "last_sync_time")
...
func (l *ldapGroup) fillFieldMap() {
	...
	l.fieldMap["has_group"] = l.HasGroup
	l.fieldMap["last_sync_time"] = l.LastSyncTime
}
